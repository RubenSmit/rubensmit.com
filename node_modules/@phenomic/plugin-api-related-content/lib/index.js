...
var apiRelatedContent = function apiRelatedContent() {
  return {
    name: "@phenomic/plugin-api-related-content",
    extendAPI: function extendAPI(_ref) {
      var apiServer = _ref.apiServer;

      // $FlowFixMe flow is lost with async function for express
      apiServer.get("/related/:path/limit-:limit/*.json", function () {
...
exports.default = apiRelatedContent;