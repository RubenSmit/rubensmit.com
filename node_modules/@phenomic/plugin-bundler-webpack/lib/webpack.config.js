...
var _getClientEnvironment = require("@phenomic/core/lib/configuration/get-client-environment.js");

var _getClientEnvironment2 = _interopRequireDefault(_getClientEnvironment);
...
module.exports = function (config) {
  return {
    ...
    output: (0, _extends3.default)({
      ...
      path: _path2.default.isAbsolute(config.outdir) ? config.outdir : _path2.default.join(config.path, config.outdir)
    ...
    plugins: [new _extractTextWebpackPlugin2.default({
      ...
      var envVars = (0, _getClientEnvironment2.default)(config);
      return new _webpack2.default.DefinePlugin({
        "process.env": (0, _keys2.default)(envVars).reduce(function (env, key) {
          env[key] = (0, _stringify2.default)(envVars[key]);
          return env;
        }, {})
      });
