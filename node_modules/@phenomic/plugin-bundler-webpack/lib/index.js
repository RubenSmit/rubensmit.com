...
var debug = require("debug")("phenomic:plugin:bundler-webpack");
...
var bundlerWebpack = function bundlerWebpack(config) {
  return {
    ...
    buildForPrerendering: function buildForPrerendering() {
