...
exports.default = withPhenomicApi;
...
function withPhenomicApi(ComposedComponent) {
  var getQueries = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {
    return {};
  };
  ...
  var PhenomicContainerWithApi = function (_React$Component) {
    (0, _inherits3.default)(PhenomicContainerWithApi, _React$Component);

    function PhenomicContainerWithApi(props, context) {
      (0, _classCallCheck3.default)(this, PhenomicContainerWithApi);

      var _this = (0, _possibleConstructorReturn3.default)(this, (PhenomicContainerWithApi.__proto__ || (0, _getPrototypeOf2.default)(PhenomicContainerWithApi)).call(this, props, context));
    ...
    (0, _createClass3.default)(PhenomicContainerWithApi, [{
      ...
      value: function render() {
        ...
        if (hasErrored) {
          ...
          return React.createElement(ComposedComponent, (0, _extends3.default)({}, this.props, { hasError: true }, props));
        }
        return React.createElement(ComposedComponent, (0, _extends3.default)({}, this.props, { isLoading: isLoading }, props));
      }
    }]);
    return PhenomicContainerWithApi;
  }(React.Component);

  // $FlowFixMe I am lazy and "it works on my computer"


  PhenomicContainerWithApi.getQueries = getQueries;
  PhenomicContainerWithApi.contextTypes = {
    query: _propTypes2.default.func,
    phenomic: _propTypes2.default.object,
    __prerendering: _propTypes2.default.bool
  };
  PhenomicContainerWithApi.displayName = "withPhenomicApi(" + displayName + ")";
  ...
  return (0, _hoistNonReactStatics2.default)(PhenomicContainerWithApi, ComposedComponent);
}