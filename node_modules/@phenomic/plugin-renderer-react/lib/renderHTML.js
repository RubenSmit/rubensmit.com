...
var renderHTML = function renderHTML(props, config) {
  var Html = void 0;
  try {
    // $FlowFixMe Shushhhh!
      ...
      return {
        ...
        Main: function Main(_ref) {
          var _ref$html = _ref.html,
              html = _ref$html === undefined ? main : _ref$html;
        ...
        Style: function Style() {
          return css ? React.createElement("link", { rel: "stylesheet", href: config.baseUrl.pathname + css }) : null;
        },
        Script: function Script() {
          return js ? React.createElement("script", { src: config.baseUrl.pathname + js, async: true }) : null;
        },
        assets: assets
      };
    }
